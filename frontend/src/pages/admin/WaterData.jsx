...
function sortRows(rows, field, direction) {
    ...
    function getSortableValue(row) {
        ...
        if (field === 'organisms') {
            ...
            return [...new Set([...wgsOrganisms, ...metagenomicOrganisms])].join(', ')
        }
                        ...
                        >
                            <Table.Thead>
                                <Table.Tr>
                                    ...
                                    <Table.Th
                                        className='col-text'
                                        onClick={() => toggleSort('gps_coordinates')}
                                    >
                                        <span className='admin-th-label'>
                                    ...
                                    <Table.Th
                                        className='col-num'
                                        onClick={() => toggleSort('water_temperature')}
                                    >
                                        <span className='admin-th-label'>
                                            <span>Temp</span>
                                            <ArrowUpDown size={12} />
                                    ...
                                    <Table.Th className='col-num' onClick={() => toggleSort('ec')}>
                                        <span className='admin-th-label'>
                                            <span>EC</span>
                                            <ArrowUpDown size={12} />
                                        </span>
                                    </Table.Th>
                                    <Table.Th className='col-num' onClick={() => toggleSort('oc')}>
                                        <span className='admin-th-label'>
                                            <span>OC</span>
                                            <ArrowUpDown size={12} />
                                        </span>
                                    ...
                                    <Table.Th
                                        className='col-text'
                                        onClick={() => toggleSort('organisms_resistance')}
                                    >
                                        <span className='admin-th-label'>
