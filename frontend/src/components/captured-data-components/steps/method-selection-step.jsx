...
import {Plus, FileJson, ScanLine} from 'lucide-react';
...
const MethodSelectionStep = ({onSelect}) => {
    return (
        <Stack align="center" py="xl" gap="lg">
            ...
            <SimpleGrid cols={{base: 1, sm: 3}} spacing="lg" w="100%" maw={760}>
                <Card
                    shadow="md"
                    padding="xl"
                    radius="md"
                ...
                >
                    <Center><ScanLine size={48} strokeWidth={1.5} color="#7db344" /></Center>
                    <Text ta="center" fw={600} mt="md" size="lg">Capture From Image</Text>
                    <Text ta="center" size="sm" c="dimmed" mt="xs">Scan a photo of a table</Text>
                </Card>
            </SimpleGrid>
        </Stack>
    );
